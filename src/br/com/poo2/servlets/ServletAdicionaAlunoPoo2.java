...
@WebServlet(name = "ServletAdicionaAlunoPoo2", urlPatterns = {"/SvtAdicionaAlunoPoo2"})
public class ServletAdicionaAlunoPoo2 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public ServletAdicionaAlunoPoo2() {
        super();
